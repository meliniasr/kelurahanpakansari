  ...
  <div class="card-body">
    <div class="row">
      <div class="col-12 table-responsive">
        <h5 class="card-title" style="font-size: 22px; margin-left:200px; margin-top:5px;"><u><b>TABEL REGISTER DOMISILI USAHA</b></u></h5>
          ...
          <?php
            ...
            foreach ($usaha as $us) : ?>
              <tr>
                ...
                <td><?php echo $us->pekerjaan_usaha ?></td>
                <td><?php echo $us->alamat_usaha ?></td>
                <td><?php echo $us->no_ktp_usaha ?></td>
                <td><?php echo $us->jenis_usaha ?></td>
                <td><?php echo $us->statuskepemilikan_usaha ?></td>

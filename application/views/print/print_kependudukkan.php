  ...
  <div class="card-body">
    <div class="row">
      <div class="col-12 table-responsive">
        <h5 class="card-title" style="font-size: 22px; margin-left:200px; margin-top:5px;"><u><b>TABEL REGISTER KEPENDUDUKKAN E-KTP & KK</b></u></h5>
        <table border="2" class="table table-striped" width="30%">
          ...
          foreach ($kependudukkan as $k) : ?>
            <tr>
              ...
              <td><?php echo $k->jenis_kelamin_kp ?></td>
              <td><?php echo $k->status_kp ?></td>
              <td><?php echo $k->alamat_kp ?></td>

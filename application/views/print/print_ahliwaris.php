  ...
  <div class="card-body">
    <div class="row">
      <div class="col-12 table-responsive">
        <h5 class="card-title" style="font-size: 22px; margin-left:200px; margin-top:5px;"><u><b>TABEL REGISTER AHLI WARIS</b></u></h5>
        <table border="3" class="table table-striped" style="width:200px;margin-left:190px;">
          <thead>
            <tr>
              <th>No.</th>
              <th>Tgl</th>

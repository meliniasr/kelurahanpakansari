  ...
  <div class="card-body">
    <div class="row">
      <div class="col-12 table-responsive">
        <h5 class="card-title" style="font-size: 22px; margin-left:200px; margin-top:5px;"><u><b>TABEL REGISTER TIDAK SENGKETA</b></u></h5>
        <table border="2" class="table table-striped" width="80%" style="margin-left:80px">
          <thead>
            <tr>
                <th>No.</th>
                <th>Tgl</th>
